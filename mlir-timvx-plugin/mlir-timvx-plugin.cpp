...
mlirGetDialectPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "TIMVX", LLVM_VERSION_STRING,
          [](DialectRegistry *registry) {
            registry->insert<mlir::timvx::TIMVXDialect>();
...
extern "C" LLVM_ATTRIBUTE_WEAK PassPluginLibraryInfo mlirGetPassPluginInfo() {
  return {MLIR_PLUGIN_API_VERSION, "TIMVXPasses", LLVM_VERSION_STRING,
          []() { mlir::timvx::registerPasses(); }};
}
