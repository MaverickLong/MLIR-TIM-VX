#!/usr/bin/env bash
#
# timvx_matmul.bash — build + run timvx_matmul.cpp.
#
# End-to-end matmul correctness test on the NPU. Same dynamic-link
# setup as timvx_smoke.bash; see timvx_matmul.cpp for what's tested
# and how the tolerance is computed.
...
src="$script_dir/timvx_matmul.cpp"
exe="$build/timvx_matmul"
